...
event and input handling, and basic UI interaction without unnecessary abstraction or overhead.
The goal is to stay lightweight, readable, and easy to extend.

Features (WIP)

    Minimal 2D rendering pipeline
    Basic input handling (mouse, keyboard)
    Lightweight UI interaction layer
    Simple audio playback
    Clean, dependency‑free PureBasic codebase
...
Raster Magic is built around a few core principles:
    ...
    Keep it small – no bloat, no unnecessary systems
    Keep it clear – readable, straightforward PureBasic code
